...
func TestInitTable(t *testing.T) {
	...
	mapping.SetRow("id", ees.NewRow().SetType(ees.Type.Long()))
	mapping.SetRow("name", ees.NewRow().SetType(ees.Type.Text()).SetSearchAnalyzer(ees.IkMaxWord()))
	mapping.SetRow("high", ees.NewRow().SetType(ees.Type.Float()))
	mapping.SetRow("ntime", ees.NewRow().SetType(ees.Type.Date()).SetFormat(ees.DateTimeFormat))
	mapping.SetRow("obj", ees.NewRow().SetType(ees.Type.Object()))
